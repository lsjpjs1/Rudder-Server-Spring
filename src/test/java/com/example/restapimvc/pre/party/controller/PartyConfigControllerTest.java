...
class PartyConfigControllerTest {
    @Autowired
    ...
    @Test
    void sendCustomerSound() throws Exception {
        String content = objectMapper.writeValueAsString(
                PartyDto.SendCustomerSoundRequest
                        .builder()
                        .customerSoundBody("test body")
                        .customerSoundType("PROBLEM")
                        .build()
        );

        mockMvc.perform(post("/customer-sound")
