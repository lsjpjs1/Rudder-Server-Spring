...
class PartyRatingControllerTest {
    @Autowired
    ...
    @Test
    void rateParty() throws Exception {
        String content = objectMapper.writeValueAsString(
                PartyDto.RatePartyRequest
                        .builder()
                        .partyRate(Double.parseDouble("3.5"))
                        .build()
        );

        mockMvc.perform(post("/parties/12/rating")
