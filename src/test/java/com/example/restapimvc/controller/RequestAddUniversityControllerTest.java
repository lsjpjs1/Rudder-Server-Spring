...
class RequestAddUniversityControllerTest {
    @Autowired
    ...
    @Test
    void requestAddUniversity() throws Exception {
        String content = objectMapper.writeValueAsString(
                RequestAddUniversityDto.RequestAddUniversityRequest.builder()
                        .requestUniversityName("koreaUniversity")
                        .build()
        );

        mockMvc.perform(post("/schools/request")
