...
class PostMessageControllerTest {
    @Autowired
    ...
    @Test
    void sendPostMessage() throws Exception {
        String content = objectMapper.writeValueAsString(PostMessageDto.SendPostMessageRequest.builder().messageBody("hi").receiveUserInfoId(221l).build());

        mockMvc.perform(post("/post-messages")
                        .content(content)
    ...
    @Test
    void readPostMessage() throws Exception {
        mockMvc.perform(patch("/post-messages/632/read")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("Authorization","Bearer eyJhbGciOiJIUzUxMiJ9..E0CSycn5hUDS8HFg6dFHn-KQl3CDd7EoDU2gO1CqpsudtYG7daO7X8XliNPn0TNXceMPW2wG-oqbvk3wgxOEpQ"))
                .andDo(print());
    ...
    @Test
    void getMyMessageRooms() throws Exception {
        mockMvc.perform(get("/post-messages/rooms")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("Authorization","Bearer eyJhbGciOiJIUzUxMiJ9..E0CSycn5hUDS8HFg6dFHn-KQl3CDd7EoDU2gO1CqpsudtYG7daO7X8XliNPn0TNXceMPW2wG-oqbvk3wgxOEpQ"))
                .andDo(print());
    ...
    void getMessagesByRoom() throws Exception {
        mockMvc.perform(get("/post-messages/rooms/44")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("Authorization","Bearer eyJhbGciOiJIUzUxMiJ9..E0CSycn5hUDS8HFg6dFHn-KQl3CDd7EoDU2gO1CqpsudtYG7daO7X8XliNPn0TNXceMPW2wG-oqbvk3wgxOEpQ"))
                .andDo(print());
